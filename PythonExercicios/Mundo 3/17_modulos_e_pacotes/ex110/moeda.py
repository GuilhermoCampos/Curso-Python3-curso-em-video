...
def resumo(preco=0, porcAum=0, porcDim=0):
    ...
    print('-'*60)
    print(f'Preço Analizado: {moeda(preco):>40}')
    print(f'Dobro do Preço: {dobro(preco, True):>41}')
    print(f'Metade do preço: {metade(preco, True):>40}')
    print(f'Aumento de {porcAum:2}%: {aumentar(preco, porcAum, True):>41}')
    print(f'Redução de {porcDim:2}%: {diminuir(preco, porcDim, True):>41}')
